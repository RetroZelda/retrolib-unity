...
public class BaseExampleState : IState
{
    ...
    private RetroLogger Logger { get { return _Logger ?? RetroLog.RetrieveCatagory("ExampleFSM"); } }
    ...
    {
        Logger.Log(string.Format("{0} - {1}", GetType().Name, szText));
    }
}
